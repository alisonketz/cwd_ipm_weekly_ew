...
##########################################################################
###
### Removing mortalities for deer that die after May 15, 2022,
### the end of the study
### these are right censors
###
#########################################################################

low_died_after <- unique(d_mort$lowtag[which(d_mort$estmortdate > "2022-05-15")],
                  d_mort$lowtag[which(d_mort$mortalertdate > "2022-05-15")],
                  d_mort$lowtag[which(d_mort$collarfound > "2022-05-15")])
